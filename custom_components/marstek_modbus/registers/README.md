...
| 32106 | Alternative for `setpoint_a` (35111). Unclear semantics, see 35111/35112. |
| 32107 | Alternative for `setpoint_b` (35112). Unclear semantics, see 35111/35112. |
...
| 35111 | `setpoint_a`. Changes with mode AND SoC — not a live EMS setpoint (constant within a snapshot while actual power varied). Observed: Charge (all)=330, Discharge 2500W SoC~46%=1000, Discharge 2500W SoC~25%=330. 330x0.1=33A, plausible BMS current limit. |
| 35112 | `setpoint_b`. Same behaviour as 35111. Observed: Charge (all)=1000, Discharge 2500W SoC~46%=750, Discharge 2500W SoC~25%=500. |
